...
static const char field_strings[] = "a0\0a1\0a2\0a3\0arch\0auid\0devmajor\0devminor\0dir\0egid\0"
	...
	"path\0perm\0pers\0pid\0ppid\0sessionid\0sgid\0subj_clr\0subj_role\0subj_sen\0"
	"subj_type\0subj_user\0success\0suid\0uid";
static const unsigned field_s2i_s[] = {
	...
	204,209,214,219,223,228,238,243,252,262,
	271,281,291,299,304,
};
...
static int field_s2i(const char *s, int *value) {
	...
	copy[i] = 0;
	return s2i__(field_strings, field_s2i_s, field_s2i_i, 45, copy, value);
	}
}
static const int field_i2s_i[] = {
	...
	104,105,106,107,108,109,110,111,112,200,
	201,202,203,210,
};
static const unsigned field_i2s_s[] = {
	219,304,49,299,99,105,44,238,86,17,
	214,12,128,281,252,271,262,243,223,195,
	169,178,157,144,228,92,22,31,109,58,
	291,204,209,40,77,187,136,63,54,0,
	3,6,9,115,
};
static const char *field_i2s(int v) {
	return i2s_bsearch__(field_strings, field_i2s_i, field_i2s_s, 44, v);
}
